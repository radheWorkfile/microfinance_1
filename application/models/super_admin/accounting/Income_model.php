<?php
    ...
    class Income_model extends CI_Model
    {
        ...
        public function all_income_data_query($where = false)
        {
            ...
            $this->db->select('inc.id,inc.source,inc.cash_received_by,inc.amount,inc.income_date,inc.status,inc_sou.source_name')->from('income as inc')->join('income_sources as inc_sou','inc_sou.id=inc.source','left');
