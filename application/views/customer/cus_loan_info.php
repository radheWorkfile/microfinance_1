            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="group_id" id="group_id" placeholder="Enter Group Id Here!"maxlength="10"oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9,. ]/g, '').replace(/\s+/g, ' ');">
                    </div>
                </div>
                <div class="col-lg-3">
...
<script>
       $("#user_search").on("submit", function(e) {
            ...
            $.ajax({
                type: "post",
                url: '<?= base_url() ?>customer/Loan_detials/client_loan',
