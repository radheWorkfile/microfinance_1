        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="<?php echo base_url();?>" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo base_url() ?>media/images/<?php echo config_item('logo_light')?>" alt="logo-light" width="85%" style="margin-top: 15px;">
                    </span>
                </a>
            </div>
            ...
            <button type="button" class="btn btn-sm px-3 font-size-16 vertinav-toggle header-item waves-effect" id="vertical-menu-btn">
                <i class="fa fa-fw fa-bars" style="margin-top: 35px;"></i>
            </button>
