...
<head>
    ...
    <style>
        *{
        ...
        .border-manage{border:0.1rem solid black;}
        .ggg{margin-right:0.5rem;}
    </style>
        ...
        <div class="card">
            ...
            <table id="odtable" class="table align-middle table-striped table-nowrap mb-0">
                        ...
                        <tr class="border-manage">
                            <th class="border-manage">Sl. No.</th>
                            <th class="border-manage">Center ID</th>
                            <th class="border-manage">Center Name</th>
                            <th class="border-manage">Client Name</th>
                            <th class="border-manage">Recovery</th>
                        </tr>
                        <?php foreach($cash_submission as $cs => $cash) { ?>
                            <tr class="border-manage">
                                <td class="border-manage"><?php echo $cs ++; ?></td>
                                <td class="border-manage"><?php echo $cash->center_id; ?></td>
                                <td class="border-manage"><?php echo $cash->center_name; ?></td>
                                <td class="border-manage"><?php echo $cash->mem_id; ?></td>
                                <td class="border-manage ggg"><?php echo $cash->emi; ?></td>
                            </tr>
