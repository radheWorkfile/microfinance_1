...
<div class="miThrd">
				     <div style="padding-left: 2.5rem;font-size: 1.5rem;">
                            ...
                            <div id="miArSrSign">
                                  <img src="<?php echo base_url('media/images/arSirSign.png');?>" style="height:10rem;width:15rem; margin:0rem 0rem -2rem 0rem;">  
                            </div>
                             
							<div style="padding:10rem 0px 8rem 0px;font-size: 1.5rem;">
...
.miScnd{border-left:2px solid #090908;padding-top: 2rem;}
.miThrd{border-left:2px solid #bd9c84;padding:2.5rem 0px 0px 3px;margin: 0px 6px 0px 6px;}
.mlDiv{border-left:2px solid #888880;margin:4rem 2.2rem 0px 2.2rem;padding:3.5rem 1rem 0px 6px;}
