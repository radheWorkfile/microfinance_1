...
<body>
    <?php
	 if ($miActn == 'clientWiseLoanReport') { ?>
        <!---------------------------------------------------------------------------------------->
        <style>
            #customers,
            .hdr {
                ...
                <div style="padding:0px 10px 10px 10px;">
                    ...
                    <table class="hdr align-middle table-nowrap mb-0">
                        ...
                        <tr>
                            ...
                            <td><span class="tTyp">Nominee  Name</span> : <span id="gurdianName" class="srcText"><?php echo $getClient->nominee_name; ?></span></td>
                        ...
                        if ($getClientEmi) {
                            ...
                            foreach ($getClientEmi as $listD) {
                                ...
                                if ($getEmiDet) {
                                    ...
                                    $recvDate = '<span class="spa_te">N/A</span>';
                                    $recvAmt = '<span class="spa_te">N/A</span>';
                                }
                                if ($listD->payment_status == '2') {
                                    ...
                                    if ($getEmiDet) {
                                        if ($listD->monthly_emi > $getEmiDet->recvAmt) {
                                            ...
                                            $paySts =  '<span class="spa_te" >Unpaid</span>';
                                        }
                                    } else {
                                        $paySts =  '<span class="spa_te">Unpaid</span>';
                                    }
                                ...
                                $getDataDetails .= '<tr>
                                    <th>' . $ctn . '.</th>
                                    <td>' . date('W', strtotime($listD->payment_date)) . '</td>
                                   <td>' . date('d-M-Y', strtotime($listD->payment_date)) . '</td>
                                   <td>' . $listD->monthly_emi . '</td>
                                   <td>' . $listD->principal_interest_amt . '</td>
                                   <td>' . $recvDate . '</td>
                                   <td>' . $recvAmt . '</td>
                                   <td>' . $paySts . '</td>
                                   <td><div></div></td>
    ...
    <?php }
	 else if ($miActn == 'centerWiseLoanReport') {
    ...
    ?>
        ...
        <div class="row" style="width:135vh;margin-top:-1rem;">
            ...
            <div class="col-lg-12">
                ...
                <div style="padding:10px;margin-left:4rem;">
                    ...
                    <table class="table align-middle table-nowrap mb-0" style="font-size:1rem;">
                        <tr>
                            ...
                            <td style="text-align:right;">
                                <span class="ctTyp">Field Schedule Date</span>:    
                                <span id="schedule_date" class="cSrcText"><?php echo $getStaffOnCenter->schedule_date . '(' . $getStaffOnCenter->schedule_time . ' )'; ?></span>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="container">
                <div class="col-lg-12">
                        ...
                        <tbody id="miLnDetailsShow">
                            ...
                            if ($getCenterWiseGroup) {
                                ...
                                foreach ($getCenterWiseGroup as $grpR) {
                                    $getCenterReport = $this->reports->centerWiseByLoanReport($miCode,$grpR->group_id,$strtDt);   // strtDt   endDt
                    ...
                    <div class="col-md-12" style="margin-top: 5rem;">
                        <p><span style="font-weight:600;font-size:1rem;margin-left:0.5rem;">Date & Time : </span><span id="disbursDate" class="cSrcText"><?php echo date('d-M-Y'); ?>&nbsp;&nbsp;&nbsp;<?php echo date('h:i:s a'); ?></span><span style="float: right; font-weight:600;font-size:1rem;">Branch Manager Signature</span></p>
                         ...
                         if ($getReportList) {
                            ...
                            foreach ($BwLdD as $bW) {
                                ...
                                if ($loanMwithoutInt+$intPaid+$emi_total) {
                                    $grndT = $loanMwithoutInt+$intPaid+$emi_total;
                                } else {
                                    $grndT = 'N/A';
                                }

                                $tdisbAmt     = $tdisbAmt+$disbAmt;
                                $tprFeeAmt    = $tprFeeAmt+$prFeeAmt;
                                $textraAmt    = $textraAmt+$extraAmt;
                                $tduesRestAmt = $tduesRestAmt+$duesRestAmt;
                                $tprevEmiAmt  = $tprevEmiAmt+$prevEmiAmt;
                                $ttest        = $ttest+$test;
                                $tloanMwithoutInt = $tloanMwithoutInt+$loanMwithoutInt;
                                $tintPaid     = $tintPaid+$intPaid;
                                $tttemi_total   = $tttemi_total+$emi_total;
                                $tttgrndT       = $tttgrndT+$grndT;
                                // $tgrndT       = $tgrndT+$grndT;
                            ...
                            <tr class="myFtrTbl">
                                ...
                                <td style="border: 1px solid black;"><?php echo $tduesRestAmt; ?></td>
                                <td style="border: 1px solid black;">0.00</td>
                                <td style="border: 1px solid black;"><?php echo $tloanMwithoutInt; ?></td>
                                <td style="border: 1px solid black;"><?php echo $tintPaid; ?></td>
                                <td style="border: 1px solid black;"><?php echo $tttemi_total; ?></td>
                                <td style="border: 1px solid black;"><?php echo $tttgrndT; ?></td>
                            </tr>
...
<?php } else if ($miActn == 'centerWiseLoanDisburshment') { ?>
	 else if ($miActn == 'centerWiseLoanDisburshment') { ?>
        <style>
            .cmpnyNm {
                text-align: center;
                font-weight: bold;
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid black;"><?php echo $centr->ifsc_code?$centr->ifsc_code:'N/A'; ?></td>
                                        <td style="border: 1px solid black;"><?php echo $centr->account_no?$centr->account_no:'N/A'; ?></td>
    ...
    <?php } 
	 elseif ($miActn == 'fieldScheduleReport') {
    ?>
        <style>
            .cmpnyNm {
                text-align: center;
            ...
            <div class="container">
                <div class="col-lg-12">
                    <table id="brReport" class="table align-middle table-striped table-nowrap mb-0">
                        ...
                        <style>
                            .border-man{border:2px solid black;line-height: 0.1;}
                        </style>
                        <tbody style="border:1px solid black;">
                            ...
                            ?>
                                    <tr style="border:1px solid black;">
                                        <td class="border-man"><strong><?php echo $cCnt; ?>.</strong></td>
                                        <td class="border-man"><?php echo $centr->centerCode; ?></td>
                                        <td class="border-man"><?php echo $centr->center_name; ?></td>
                                        <td class="border-man"><?php echo date('d-M-Y', strtotime($centr->schedule_date)); ?></td>
                                        <td class="border-man"><?php echo $centr->schedule_day; ?></td>
                                        <td class="border-man"><?php echo $centr->schedule_time; ?></td>
                                        <td class="border-man"><?php echo $centr->full_name; ?></td>
                                    </tr>
                                <?php  }
                            } else { ?>
                                <tr>
