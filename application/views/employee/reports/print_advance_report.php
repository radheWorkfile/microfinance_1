        ...
        <div class="col-lg-12">
            <div style="padding:10px;">
                <div class="cmpnyHedng"><?php echo config_item('company_name') ?> <br />
                    <div class="brAddr">Advance Report | <?php echo $this->session->userdata('branch_office') ?></div>
                </div>
            </div>
            <div class="row">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <table id="profiletable" class="table align-middle table-striped table-nowrap mb-0 table-responsive">
                    <thead class="header-green">
                        <tr>
                            ...
                            <th class="heaMan textSize">Total Client</th>
                            <th class="heaMan textSize">Recover Amount</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($advance_data as $pro => $profile) {  ?>
                            <tr>
                ...
                <br><br><br><br><br>
<p><span class="float-lg-start" style="border-bottom:1px solid black;padding-bottom:0.5rem;margin-top:5rem;">&nbsp;&nbsp;&nbsp;&nbsp;Staff Signature&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="border-bottom:1px solid black;padding-bottom:0.5rem;margin-left:26rem;">&nbsp;&nbsp;&nbsp;&nbsp;B.M Signature&nbsp;&nbsp;&nbsp;&nbsp;</span></p>
            </div>
            <!-- end card-body -->
        </div>
        <!-- end card -->
