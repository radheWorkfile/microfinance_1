                    ...
                    <div class="col-lg-12">
                        <div style="padding:10px;">
                            <div class="cmpnyHedng"><?php echo config_item('company_name') ?> <br/>
                                <div class="brAddr">OD Payment Report | <?php echo $this->session->userdata('branch_office') ?></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <span class="tTyp">Week: </span>:<span id="staffName" class="srcText"><?php echo date('W'); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                <table id="odtable" class="table align-middle table-striped table-nowrap mb-0 table-responsive">
