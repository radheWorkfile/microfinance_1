<style>
    ...
    .textSize{font-size:0.6rem;border:1px solid #e2e2e2;}
        ...
        <div class="col-lg-12">
            <div style="padding:10px;">
                <div class="cmpnyHedng"><?php echo config_item('company_name') ?> <br />
                    <div class="brAddr">Fore Close Loan Report | <?php echo $this->session->userdata('branch_office') ?></div>
                </div>
            </div>
            <div class="row">
                ...
                <table id="profiletable" class="table align-middle table-striped table-nowrap mb-0 table-responsive">
                    <thead class="header-green">
                        <tr>
                            ...
                            <th class="heaMan textSize">Client ID</th>
                            <th class="heaMan textSize">Client Name</th>
                            <th class="heaMan textSize">Client DOB</th>
                            <th class="heaMan textSize">Guardian Name</th>
                            <th class="heaMan textSize">Disburse Date</th>
                            <th class="heaMan textSize">Forse Close Date</th>
                            <th class="heaMan textSize">Recovered Amount</th>
                            <th class="heaMan textSize">LST Rec Amount</th>
                            <th class="heaMan textSize">Pre Closed</th>
                            <th class="heaMan textSize">Remark</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach($record as $pro => $profile) {  ?>
                            <tr>
                                ...
                                <th class="textSize"><?php echo $profile->member_id; ?></th>
                                <th class="textSize"><?php echo $profile->member_name; ?></th>
                                <th class="textSize"><?php echo $profile->dob; ?></th>
                                <th class="textSize"><?php echo $profile->nominee_name; ?></th> 
                                <th class="textSize"><?php echo $profile->disbursed_data; ?></th> 
                                <th class="textSize"><?php echo $profile->loan_close_date; ?></th>
                                <th class="textSize"><?php echo $profile->recovered_amount; ?></th>
                                <th class="textSize"><?php echo $profile->lst_rec_amount; ?></th>
                                <th class="textSize"><?php echo $profile->loan_close_date; ?></th>
                                <th class="textSize"><?php echo $profile->remark; ?></th>
