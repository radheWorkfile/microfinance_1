...
<div class="card-body back">
    <h1 class="name"style="color:#0576b9;">
        <?php echo config_item('company_name') ?>
        </h4>
        <h4 class="name"style="color:#0576b9;">
        <div class="brAddr">Recovery Update | <?php echo $this->session->userdata('branch_office')?></div>
        </h4>
        <h2 class="name"style="color:#8B1324;">EMI Bill
    </h1>
