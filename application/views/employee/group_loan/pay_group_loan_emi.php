<div class="row">
    <div class="col-lg-6">
        ...
        <div class="mb-3">
            <input type="hidden" class="form-control" name="emi_id" id="emi_id" value="<?php echo $emi_data['id'] ?>">
            <input type="hidden" class="form-control" name="member_id" id="member_id" value="<?php echo $emi_data['member_id'] ?>">
            <input type="hidden" class="form-control" name="group_loan_id" id="group_loan_id" value="<?php echo $emi_data['group_loan_id'] ?>">
            <input type="text" class="form-control" name="total_payble_amount" id="total_payble_amount" value="<?php echo $emi_data['monthly_emi'] ?>" readonly>
        </div>
    </div>
    <div class="col-lg-6">
    ...
    <div class="col-lg-6">
        ...
        <div class="mb-3">
            <input type="date" class="form-control" name="emi_date" id="emi_date" value="<?php echo $emi_data['payment_date'] ?>" readonly>
        </div>
    </div>
    <div class="col-lg-6">
        <label>Paid Amount:<span class="text-danger">*</span></label>
        <div class="mb-3">
            <input type="text" class="form-control" name="paid_amount" id="paid_amount" placeholder="Enter Paid Amount" onchange="return dues(this.value)"maxlength="10" oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')">
        </div>
    </div>
    <div class="col-lg-6">
    ...
    <div class="col-lg-6" id="cash_received_section" style="display: none;">
        ...
        <div class="mb-3">
            <input type="text" class="form-control" name="cash_received_by" id="cash_received_by" placeholder="Enter Name Of Cash Receiver"maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
        </div>
    </div>
    <div class="col-lg-6">
    ...
    <div class="col-lg-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="penelty_amount" id="penelty_amount" placeholder="Enter Penalty Amount" maxlength="10" oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')">
        </div>
    </div>
    <div class="col-lg-6">
        <label>Payment Remarks:<span class="text-danger">*</span></label>
        <div class="mb-3">
            <textarea name="pay_remarks" id="pay_remarks" class="form-control"maxlength="80"oninput="this.value = this.value.toLowerCase().replace(/[^a-z0-9,. ]/g, '').replace(/\s+/g, ' ');"></textarea>
        </div>
    </div>
    <div class="col-lg-6">
