...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form id="filter_od_data" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <table id="odtable" class="table table-bordered dt-responsive nowrap w-100">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myExtraLargeModalLabel">OD Recovery Conformation</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="od_recovery_conformation_updata" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="modal-body">
                    <div id="up_od_recovery"></div>
                </div>
