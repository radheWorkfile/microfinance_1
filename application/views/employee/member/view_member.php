        ...
        <div class="col-12 col-md-12 col-lg-12 order-1 order-md-2">
            <div class="row">
                <div class="col-6 col-sm-6">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <li class="list-group-item">
                            <b>Religion</b>
                            <a style="float: right;">
                                <?php if($member['religion'] == 1) { echo "Hinduism"; } elseif($member['religion'] == 2) { echo "Islam"; } elseif($member['religion'] == 3) { echo "Christianity"; } elseif($member['religion'] == 4) { echo "Sikhism"; } else { echo ""; }  ?>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <b>Date of Joining</b>
                ...
                <div class="col-6 col-sm-6">
                    ...
                    <h3 class="mb-sm-0 font-size-18 fw-bold" style="padding: 15px;">Center Status</h3>
                    <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                            <b>Center Name </b>
                            <a style="float: right;">
                                <?php echo $member['cent_name']; ?>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <b>Group Name </b>
                            <a style="float: right;">
                                <?php echo $member['grp_name']; ?>
                            </a>
                        </li>
                    </ul>
                </div>
