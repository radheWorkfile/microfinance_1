...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div><button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal"    data-bs-target=".bs-example-modal-md" style="float:right;"> <i class="fas fa-plus"></i> Create SubDocument </button></div><br><br><br>
                <table id="leadtable" class="table table-bordered dt-responsive nowrap w-100">
                    <thead>
                        <tr>
                            <th>Sl. No.</th>
                            <th>Document Name</th>
                            <th>SubDocumenmt Name</th>
                            <th>Description</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    ...
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="document_name" id="document_name" class="form-control">
                                    ...
                                    <?php foreach($docu as $do) { ?>
                                        <option value="<?php echo $do['id'] ?>"><?php echo $do['document_name'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="sub_document_name" id="sub_document_name" placeholder="Enter Sub Document Name"oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ');">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="mb-3">
...
<div class="modal fade update_category" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form id="sub_document_updata" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="modal-body">
                    <div id="up_sub_document"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary waves-effect" data-bs-dismiss="modal">Close</button>
...
<script src="<?php echo base_url() ?>media/js/super_admin/category/sub_document.js"></script>
