<div class="row">
    <div class="col-lg-6">
        ...
        <div class="mb-3">
            ...
            <input type="hidden" class="form-control" name="loan_id" id="loan_id" value="<?php echo $emi_data['loan_id'] ?>">
    ...
    <div class="col-lg-6">
        ...
        <div class="mb-3">
            <input type="text" class="form-control" name="current_rest_amount" id="current_rest_amount" value="<?php if(!empty($last_rest_amount['rest_amount'])) { echo $last_rest_amount['rest_amount']; } else { echo "0"; } ?>" readonly>
        </div>
    </div>
    <div class="col-lg-6">
    ...
    <div class="col-lg-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="penelty_amount" id="penelty_amount" placeholder="Enter Penalty Amount">
        </div>
    </div>
    <div class="col-lg-6">
