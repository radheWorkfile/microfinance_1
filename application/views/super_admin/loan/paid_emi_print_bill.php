...
<div class="card-body back">
    ...
    <table>
        <tr>
            <td class="tds"><span class="head">CUST. NAME</span> <span style="font-size:16px;">:
                    <?php echo $priemi['full_name'] ?>
                </span></td>
            <td class="tds"><span class="head">CUST. ID</span> :
    ...
    <table class="table" style="width:100%;">
        ...
        <tr>
            <?php $this->load->model('super_admin/Common_model', 'common_model'); ?>
            <td class="td">
                <?php if (!empty($priemi['penelty_amount'])) {
