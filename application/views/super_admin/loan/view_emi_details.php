...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <table id="emitable" class="table table-bordered dt-responsive nowrap w-100">
                    <thead>
                        <tr>
                            <th>S.No.</th>
                            <th>Payment Date</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myExtraLargeModalLabel">Pay Emi Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="emi_updata" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
<!-- View Lead Modal End-->
<script src="<?php echo base_url() ?>media/js/super_admin/emi.js"></script>
            ...
            printTable: function(search_data) {
                ...
                $("#emitable").DataTable({
                    ...
                    "ajax": {
                        ...
                        "url": base_url + 'super_admin/Loan/all_emi_data',
                        "type": "POST",
                        "dataSrc": "data",
                        "data": {
