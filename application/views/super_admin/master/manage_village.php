...
<span id="adBtnActn">super_admin/master/village/addNew</span>
<span id="minBtnActn">super_admin/master/village/cStatus</span>
<span id="nCreateCode"><?php echo $vCodeAuto;?></span>
<a href="javascript:void(0);" class="ititle miAction" id="miniMize" data-id="Manage Village"  title="Back to dashboard" ><i class="bx bx-minus"></i></a>
<a href="javascript:void(0);" class="ititle miAction" id="AddNew" data-id="Add New Village"  title="Create New"><i class="fas fa-plus"></i></a>
...
<form id="villageMaster" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    <div class="row" id="vCreateNew"  style="display:none;">
        <div class="col-md-6">
           <div class="mb-3">   
              <label class="form-label">Village Code </label>
			  	<input class="form-control mIsCode" type="text" readonly="readonly" value="<?php echo $vCodeAuto;?>" name="vCode" id="vCode"> 
           </div>   
        </div>
        <div class="col-md-6"> 
           <div class="mb-3">
        ...
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="village_name" id="village_name" placeholder="Enter Village Name" maxlength="25" oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ');">
            </div>
        </div>
        <div class="col-lg-6">
            <div class="mb-3">
                <label class="form-label">Distance (in Km)<span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="distance" id="distance" placeholder="Enter Distance value" maxlength="5" oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')">
            </div>
        </div> 
        <div class="col-lg-6">
            <div class="mb-3">
       ...
       <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            ...
            <input class="form-control" type="text" name="noCentr" id="noCentr" value="5"maxlength="5" oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')">
        </div>
 ...
 <input type="hidden" id="locTrgt" value="super_admin/master/village/cStatus">
<!-- JavaScript -->
