...
<span id="adBtnActn">super_admin/master/branch/addNew</span>
<span id="minBtnActn">super_admin/master/branch/cStatus</span>
    ...
    <div class="row" id="vCreateNew" style="display:none;">
        ...
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <input class="form-control miCln" type="text" name="branch_name" id="branch_name" placeholder="Enter Branch Name"oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ');"
                >
            </div>
        </div>
         <div class="col-lg-6">
		...
		<div class="col-lg-12">
            <div class="mb-3">
				...
				<textarea class="form-control miCln" rows="2" name="off_addr" id="off_addr" placeholder="Enter Office Address"oninput="this.value = this.value.toLowerCase().replace(/[^a-z0-9,. ]/g, '').replace(/\s+/g, ' ');"></textarea>
			</div>
        </div>
		<div class="col-lg-6">
            <div class="mb-3">
