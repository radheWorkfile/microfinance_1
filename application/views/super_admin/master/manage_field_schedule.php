...
<div class="card">
    <div class="ami_dev"><span><i class="bx bx-home"></i></span> <span id="mstrTitle">
        ...
        <span id="adBtnActn">super_admin/master/field_schedule/addNew</span>
        <span id="minBtnActn">super_admin/master/field_schedule/cStatus</span>
        <span id="nCreateCode">
            <?php echo $vCodeAuto; ?>
        </span>
...
<input type="hidden" id="locTrgt" value="super_admin/master/field_schedule/cStatus">
<!-- JavaScript -->
