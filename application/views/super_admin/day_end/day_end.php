...
<div class="card">
    <div class="ami_dev"><span><i class="bx bxs-user-pin" style="font-size:1.1rem;"></i></span> <span id="mstrTitle"><?php echo config_item('work_end');?></span>

        <form action="<?php echo base_url(); ?>super_admin/Day_end/day_end" method="post" id="addEndDataa">
            <a href="javascript:void(0);" class="ititlee miAction" id="AddNewww" data-id="<?php echo 'Date :-' . date('Y-m-d'); ?>" title="Back to dashboard"><span class="btn btn-light text-primary">
                    ...
                    <?php }else if(count($dayEndData)!= 0){ ?>
                        <butto type="submit" id="submit" style="border:2px solid #eff2f7;">End Day</butto>
                        <?php } ?>
                    </span></a>
        </form>
...
<script src="<?php echo base_url() ?>media/js/super_admin/day-end.js"></script>
