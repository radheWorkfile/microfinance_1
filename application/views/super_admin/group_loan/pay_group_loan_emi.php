<div class="row">
    ...
    <div class="col-lg-6" id="cash_received_section" style="display: none;">
        ...
        <div class="mb-3">
            <input type="text" class="form-control" name="cash_received_by" id="cash_received_by" placeholder="Enter Name Of Cash Receiver"maxlength="25" oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ');">
        </div>
    </div>
    <div class="col-lg-6">
    ...
    <div class="col-lg-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="penelty_amount" id="penelty_amount" placeholder="Enter Penalty Amount" maxlength="5" oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')">
        </div>
    </div>
    <div class="col-lg-6">
