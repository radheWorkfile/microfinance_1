    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myExtraLargeModalLabel">Update Commission Data</h5>
...
<script src="<?php echo base_url() ?>media/js/agent/commission.js"></script>
