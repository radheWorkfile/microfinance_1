        ...
        printTable: function(search_data) {
            ...
            $("#leadtable").DataTable({
                ...
                "ajax": {
                    ...
                    "url": base_url + 'super_admin/Staff/staff_data',
                    "type": "POST",
                    "dataSrc": "data",
                    "data": search_data
...
function assign_staff(id) {
    $.ajax({
        url: base_url + 'super_admin/Staff/assig_to_other',
        type: "POST",
        data: {
            'id': id
        },
        success: function(data) {
            $('#assign-staff').html(data);
        },
    });
}

$("#update_ass_staff").on("submit", function(e) {
    e.preventDefault();
    $.ajax({
        type: "post",
        url: base_url + 'super_admin/Staff/udpate_staff',
        data: new FormData(this),
        processData: false,
        contentType: false,
        cache: false,
