...
$(document).ready(function() {
            ...
            $("#brReport").DataTable({
                ...
                "drawCallback": function(settings) {
                    ...
                    for (var i = 0; i < getPrdet; i++) {
                        ...
                        disTotalAmt += parseInt($(api.column(12).data()[i]).text());
                        //  proFeeTotalAmt += parseInt($(api.column(13).data()[i]).text());
    ...
    $(".ActnCmdByAmi").click(function() {
        ...
        if (actNbtn == 'miReports') {
                ...
                function(htmlAmi) {
                    ...
                    if (htmlAmi.icon == 'error') { swlToast(htmlAmi); } else {
                        if (htmlAmi.cWiseReportLn == 'cWiseReportLn') {
                            ...
                            $('#miPrintReports').removeAttr('disabled');
                            $('#staffName').html(' ' + htmlAmi.full_name + '( ' + htmlAmi.staff_id + ' )');
                            $('#miLnDetailsShow').html(htmlAmi.loanDtl);
                        }
                    }
                }, 'json');
            ...
            // alert(fsdfsdf + " " + "hello Nikhil sir sec"); // radhe_kr
