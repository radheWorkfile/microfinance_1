...
function manageFieldSchedule(str, target, acTyp) {
    ...
    $("#locTrgt").val('employee/master/field_schedule/editDetails');
    $("#miniMize").show();
    $("#AddNew").hide();
    $("#vTbleShw").hide();
    $("#vCreateNew").show();
...
function manageVillage(str, target, acTyp) {
    let getResource = $('#base_url').val() + target;
    if (acTyp == 'view') { $("#sbmtBtn").hide(); } else if (acTyp == 'edit') { $("#sbmtBtn").show(); }
    $("#locTrgt").val('employee/master/village/editDetails');
    $("#miniMize").show();
    $("#AddNew").hide();
    $("#vTbleShw").hide();
    $("#vCreateNew").show();
...
function manageCenter(str, target, acTyp) {
    ...
    let getResource = $('#base_url').val() + target;
    if (acTyp == 'view') { $("#sbmtBtn").hide(); } else if (acTyp == 'edit') { $("#sbmtBtn").show(); }
    $("#locTrgt").val('employee/master/center/editDetails');
    $("#miniMize").show();
    $("#AddNew").hide();
    $("#vTbleShw").hide();
    $("#vCreateNew").show();
...
function manageGroup(str, target, acTyp) {
    ...
    let getResource = $('#base_url').val() + target;
    if (acTyp == 'view') { $("#sbmtBtn").hide(); } else if (acTyp == 'edit') { $("#sbmtBtn").show(); }
    $("#locTrgt").val('employee/master/group/editDetails');
    $("#vTbleShw").hide();
    $("#vCreateNew").show();
    $('#target').val(str);
    $.post(getResource, { id: str, acTyp: acTyp }, function(htmlAmi) {
        //$("#testing_pr").html(htmlAmi.miData.center_id);
...
function manageBranch(str, target, acTyp) {
    let getResource = $('#base_url').val() + target;
    if (acTyp == 'view') { $("#sbmtBtn").hide(); } else if (acTyp == 'edit') { $("#sbmtBtn").show(); }
    $("#locTrgt").val('employee/master/branch/editDetails');
    $("#miniMize").show();
    $("#AddNew").hide();
    $("#vTbleShw").hide();
    $("#vCreateNew").show();
